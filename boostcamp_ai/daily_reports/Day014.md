...
- 시퀀스를 시퀀스로 변형하는 것이 주 목적
  ...
  <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204171905584.png" alt="image-20210204171905584" style="zoom: 50%;" />
...
- 기존 RNN 모델은 가령 3개의 단어가 입력되면 모델이 3번 작동하는데, Transformer는 여러 개의 단어가 입력되어도 단 한번만 작동(단 generate시에는 한 단어씩 찍어냄. 내부적으로 학습할 때 한번만 작동한다는 것!)
  ...
  <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204172003943.png" alt="image-20210204172003943" style="zoom: 67%;" />
...
- `왜 이게 잘 될까?: *Self-attention*
  ...
  ![image-20210204230037252](C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204230037252.png)

  - Transformer는 크게 인코더와 디코더로 구성되어 있는데, 위 그림과 같이 Encoder에서는 각 단어 간의 관계를 판별할 수 있는 Self-attention 과정을 거침

  ![self_attention](C:\Users\iloveslowfood\Documents\workspace\iloveCookBook\boostcamp_ai\etc\images\week03\self_attention.png)
  ...
  - 특정 단어의 attention 계산 과정은 다음과 같음
    ...
    1. 입력받은 문장에 대해 Query, Key, Value 행렬를 생성
       ...
       ![qkv](C:\Users\iloveslowfood\Documents\workspace\iloveCookBook\boostcamp_ai\etc\images\week03\qkv.png)
...
- Multi-headed attention
  ...
  - 아직 개념들을 완전히 이해하지 못했지만.... 결론적으로 컨셉은 다음 그림으로 이해할 수 있다 이말이야!
    ...
    ![image-20210204232129732](C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204232129732.png)

    - 이렇게 본다면 좀더 다차원적인 접근(=일반화된 예측)이 가능해지는 것

      ![image-20210204232308770](C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204232308770.png)
