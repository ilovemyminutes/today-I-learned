...
- 시퀀스 데이터를 다루기 위해서는 조건부 확률을 모델링한다는 특성상 가변적인 데이터를 다룰 수 있는 모델이 필요
  ...
  - AR(τ), 자기회귀 모델(autoregressive model)
    ...
    <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204105603741.png" alt="image-20210204105603741" style="zoom: 50%;" />
  ...
  - 위와 다른 방법은, 잠재변수를 활용한 잠재 AR 모델
    ...
    - 직전 정보를 제외한 나머지 정보들을 H_{t}의 잠재변수로 인코딩해서 활용
      ...
      <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204105224071.png" alt="image-20210204105224071" style="zoom:50%;" />
...
- 가장 기본적인 RNN 모형은 MLP와 유사
  ...
  <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204110650288.png" alt="image-20210204110650288" style="zoom: 67%;" />
...
- 잠재변수를 제대로 다룰 수 있는 모델 구조는 다음과 같음 => 찐 RNN 모델! 
  ...
  <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204110724833.png" alt="image-20210204110724833" style="zoom: 67%;" />
...
- RNN의 역전파
  ...
  - 잠재변수의 연결그래프에 따라 순차적으로 계산
    ...
    <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204112424122.png" alt="image-20210204112424122" style="zoom: 67%;" />
...
- 시퀀스 길이가 길어질 수록 일부 항이 불안정해짐
  ...
  ![image-20210204113029054](C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204113029054.png)

Vanishing Gradient를 해결하자

- Vanishing Gradient 문제: 그래디언트가 0에 수렴하는 문제

  <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204113228365.png" alt="image-20210204113228365" style="zoom:80%;" />
...
- Naive Sequence Model
  ...
  - 시퀀셜 모델의 가장 어려운건 뭘까?
    ...
    ![image-20210204115831171](C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204115831171.png)
...
- Autoregressive Model
  ...
  - 과거의 고정된 길이만을 관찰하는 것
    ...
    ![image-20210204120016367](C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204120016367.png)

  - Markov model(first-order autoregressive model)

    ![image-20210204120113066](C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204120113066.png)
...
- Latent Autoregressive Model
  ...
  - 위 단점을 극복하자!: *Hidden State*(과거의 정보를 요약)
    ...
    <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204120857484.png" alt="image-20210204120857484" style="zoom: 50%;" />
...
- 자기 자신으로 돌아오는 구조가 존재하는 것이 MLP와의 차이
  ...
  <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204121155139.png" alt="image-20210204121155139" style="zoom: 50%;" />
...
- RNN의 최대 단점: 먼 과거의 정보를 활용하기 어려움
  ...
  <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204121433955.png" alt="image-20210204121433955" style="zoom:50%;" />

  - Long-term dependencies: 먼 과거는 미래 예측이 사용되기 어려움

    <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204121813782.png" alt="image-20210204121813782" style="zoom: 50%;" />

  - 모델이 학습되면서 특징이 hidden state에 요약되는데, 이 과정에서 먼 과거의 state는 살아남기가 어려움

  - 이 문제를 구체적으로 다시 보자

    <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204122227191.png" alt="image-20210204122227191" style="zoom:50%;" />
...
- Vanilla RNN의 구조
  ...
  <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204122428722.png" alt="image-20210204122428722" style="zoom:50%;" />

- LSTM의 구조

  <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204122451417.png" alt="image-20210204122451417" style="zoom:50%;" />

  - 와 복잡한거 봐. 쪼개서 봐보자

    <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204122528618.png" alt="image-20210204122528618" style="zoom: 50%;" />

- Gated Recurrent Unit

  -  GRU가 LSTM보다 구조가 단순하나, 오히려 성능이 더 좋은 경우도 많음 
  - 네트워크의 파라미터가 적어서 generalization이 잘 된거 아닐까 추측됨

- 요새는 Transformer가 싹다 잡아먹는다고..
...
- 시퀀스를 시퀀스로 변형하는 것이 주 목적
  ...
  <img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204171905584.png" alt="image-20210204171905584" style="zoom: 67%;" />
...
- 기존 RNN 모델은 가령 3개의 단어가 입력되면 모델이 3번 작동하는데, Transformer는 여러 개의 단어가 입력되어도 단 한번만 작동(단 generate시에는 한 단어씩 찍어냄. 내부적으로 학습할 때 한번만 작동한다는 것!)
  ...
  ![image-20210204172003943](C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210204172003943.png)
