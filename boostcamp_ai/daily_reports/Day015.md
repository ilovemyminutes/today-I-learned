...
<img src="C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210205123103519.png" alt="image-20210205123103519" style="zoom:80%;" />
...
- Variational inference(VI)
  ...
  ![image-20210205203536883](C:\Users\iloveslowfood\AppData\Roaming\Typora\typora-user-images\image-20210205203536883.png)
...
- 한계
  ...
  - prior fitting term은 KL Divergence term이 포함되어 기본적으로 미분이 가능해야 하기 때문에 latent prior distribution에 대해 다양한 가정이 어려움
    ...
    - 따라서 Latent prior distribution에 대해 가우시안 분포(특히 isotropic 가우시안 분포)를 가정하는 경우가 많음
      ...
      ![image-20210205204002936](C:\Users\iloveslowfood\Documents\workspace\iloveCookBook\boostcamp_ai\etc\images\week03\VAE2.png)
