...
- 계산 그래프(computation graph): 이웃 정점들의 정보를 집계, 응축하는 과정을 반복
  ...
  ![gnn_basic_1](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week05\gnn_basic_1.jpg)

  - 각 정점에서의 이웃 정점들을 활용하여 속성을 집계

    ![gnn_basic_2](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week05\gnn_basic_2.jpg)

    - 따라서, 단계마다 정점별 집계되는 값이 다르게 측정, 즉 해당 정점에서의 이웃 정점 간 관계성을 반영할 수 있음
    - 몇 번의 집계 과정을 거칠지는 설정할 수 있음(하이퍼 파라이터)

  ![gnn_basic_3](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week05\gnn_basic_3.jpg)
...
- 정점 임베딩과 같은 맥락으로, 그래프 임베딩은 그래프 전체를 벡터 공간으로 임베딩하는 것을 의미
  ...
  ![graph_embedding_1](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week05\graph_embedding_1.jpg)
...
- 그래프 신경망의 레이어 수가 증가하면서 각 정점의 임베딩이 서로 유사해지는 현상
  ...
  ![graph_embedding_2](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week05\graph_embedding_2.jpg)
...
- 0번째 층을 제외하고는 신경망 없이 집계 함수 단순화
  ...
  ![graph_embedding_3](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week05\graph_embedding_3.jpg)

- 레이어 수 증가에 따른 정확도 감소 문제 X

  ![graph_embedding_4](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week05\graph_embedding_4.jpg)
...
- 이러한 문제를 데이터 증강을 통해 해결
  ...
  ![graph_embedding_5](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week05\graph_embedding_5.jpg)
...
- 확실하게 정확도가 개선됨!
  ...
  ![graph_embedding_6](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week05\graph_embedding_6.jpg)