...
- 종류에 따라 기하학적 성질이 달라진다!
  ...
  ![norm](https://github.com/iloveslowfood/iloveCookBook/blob/main/boostcamp_ai/etc/images/norm.png?raw=true)
...
- 내적은 정사영의 길이(||x||cosθ)를 벡터 y의 길이 ||y||만큼 조정한 것
  ...
  ![](https://github.com/iloveslowfood/iloveCookBook/blob/main/boostcamp_ai/etc/images/innerproduct.png?raw=true)
...
- i번째 행벡터와 j번째 열벡터 간 내적을 성분으로 갖는 행렬 계산
  ...
  <img src="https://github.com/iloveslowfood/iloveCookBook/blob/main/boostcamp_ai/etc/images/matmul.png?raw=true" style="zoom:67%;" />
...
- 행렬곱에 `np.inner` 함수를 사용하면 다음과 같이 행렬곱 연산과 다르게 진행되니 주의!
  ...
  <img src="https://github.com/iloveslowfood/iloveCookBook/blob/main/boostcamp_ai/etc/images/np_inner.png?raw=true" style="zoom:67%;" />
...
- (1) 행과 열 숫자가 같고 (2) determinant가 0이 아닌 경우에만 계산 가능
  ...
  - `np.linalg.pinv(x)`
    ...
    <img src="https://github.com/iloveslowfood/iloveCookBook/blob/main/boostcamp_ai/etc/images/moore_penrose_pinv.png?raw=true" style="zoom: 67%;" />
...
- `np.linalg.pinv`를 이용하면 데이터를 선형 모델로 보고, 선형회귀식을 찾을 수 있음
  ...
  <img src="https://github.com/iloveslowfood/iloveCookBook/blob/main/boostcamp_ai/etc/images/np_pinv_1.png?raw=true" alt="image-20210125155021242" style="zoom:80%;" />

  <img src="https://github.com/iloveslowfood/iloveCookBook/blob/main/boostcamp_ai/etc/images/np_pinv_2.png?raw=true" alt="image-20210125155046144" style="zoom:80%;" />
...
- 사이킷런의 `LinearRegression`을 활용해도 구할 수 있음
  ...
  - `np.linalg.pinv`와 결과값이 다름
    ...
    <img src="https://github.com/iloveslowfood/iloveCookBook/blob/main/boostcamp_ai/etc/images/sckit_learn_LR.png?raw=true" style="zoom:67%;" />
