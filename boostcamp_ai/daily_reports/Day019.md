...
![transformer_self_attention_1](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\transformer_self_attention_1.jpg)
...
- 수식으로 살펴보기
  ...
  ![transformer_self_attention_4](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\transformer_self_attention_4.jpg)
  ...
  - 좀더 확장하자면, 쿼리 행렬과 키 행렬을 행렬곱한 뒤, 소프트맥스를 취하고 밸류 행렬과 행렬곱
    ...
    - 그림으로 표현하자면 아래 그림과 같음
      ...
      ![transformer_self_attention_5](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\transformer_self_attention_5.jpg)
...
- 스케일링
  ...
  ![transformer_self_attention_6](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\transformer_self_attention_6.jpg)
...
![multi_attn_1](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\multi_attn_1.jpg)

- 즉, 학습 파라미터인 Wq, Wk, Wv 쌍을 여러 개 만들어 여러 개의 Attention을 생성한 뒤, 모든 Attention을 고려하여 output을 도출

  ![multi_attn_2](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\multi_attn_2.jpg)
...
- Self Attention의 시간복잡도
  ...
  ![multi_attn_3](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\multi_attn_3.jpg)
...
- 때문에, Positional Encoding을 통해 순서 정보를 추가적으로 얻음
  ...
  ![positional_encoding_1](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\positional_encoding_1.jpg)

- 순서 정보는 특정한 스칼라로 표현하는 것이 아닌, 벡터로서 표현하며, 각 성분은 sin, cos의 주기 함수로 표현된다.

- 순서 벡터를 기존의 임베딩 벡터에 더해줌으로써 순서 정보를 반영하게 됨!

  ![positional_encoding_2](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\positional_encoding_2.jpg)
...
- Transformer 또한 휴리스틱하게 learning rate 조정 스케줄이 마련되어 있음
  ...
  ![lr_scheduler](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\lr_scheduler.jpg)

Decoder

![decoder](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\decoder.jpg)
...
- (1) Masked Multi-Head Attention: *치팅 방지!*
  ...
  - 그렇기 때문에, 미래에 등장할 정답 단어를 가려두고 학습을 진행하는데, 이러한 방법이 바로 Masked Multi-Head Attention
    ...
    ![mask](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\mask.jpg)
...
![benchmark](C:\Users\iloveslowfood\Documents\workspace\iloveTIL\boostcamp_ai\etc\images\week04\benchmark.jpg)
